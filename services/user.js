...
const { sendMail, getStructure } = require("../services/function");
...
class User extends Model {
  ...
  async forgotPassword() {
    ...
    sendMail(
      ...
      "Quên mật khẩu",
      forgotCode,
      getStructure("QUÊN MẬT KHẨU", forgotCode)
    );
  ...
  static async findBySomeThing(key) {
    ...
    var found =
      (await this.findByEmail(key)) ||
      (await this.findByUsername(key)) ||
      (await this.findByPhoneNumber(key));
